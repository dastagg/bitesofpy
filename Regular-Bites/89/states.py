...
def combine_state_names_and_abbreviations(
    ...
    for i in us_state_abbrev:
        abbrev_list.append(us_state_abbrev[i])

    # sort both lists
    sort_abbrev = sorted(abbrev_list)
    sort_states = sorted(states)

    # use slicing to return the list
    return sort_abbrev[0:10] + sort_states[-10:]
